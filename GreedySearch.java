...
public class GreedySearch {
	private ArrayList<Node> GSsolutionPath = new ArrayList<>();
	
public GreedySearch (int[] initialLocation, int[] targetlLocation , int[][] maze , int height , int width , int heuristic) {
	Node root = new Node();
    ...
    CompareNodeH cn = new CompareNodeH();
    PriorityQueue<Node> fringe = new PriorityQueue<Node>(cn); 
    ...
    calculateGreedySearch ( n,  goalNode, root, maze,  height ,  width , heuristic , closedList , fringe);
	}

	
	
	public void calculateGreedySearch (Node n, Node goalNode,Node root, int[][] maze, int heightOfImage , int widthOfImage , int heuristic , HashMap <String, Integer> closedList ,PriorityQueue<Node> fringe) {
		int maxFrontier = 0;
		int depth = 0;
		int expandedNodes =0;
		closedList.put("x:"+n.getX()+"y:"+n.getY() , 1);
	...
	public void displaySolutionPath (HashMap <String, Integer> closedList, int expandedNodes , int depth, int maxFrontier, Node n, Node root, Node goalNode) {
        ...
        setGSsolutionPath(solutionPath);
	...
	static class CompareNodeH implements Comparator<Node>
	{
	...
	public ArrayList<Node> getGSsolutionPath() {
		return GSsolutionPath;
	}

	public void setGSsolutionPath(ArrayList<Node> gSsolutionPath) {
		GSsolutionPath = gSsolutionPath;
	}
 }