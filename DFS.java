...
public class DFS {
	private ArrayList<Node> DFSSolutionPath = new ArrayList<>();
	public DFS (int[] initialLocation, int[] targetlLocation , int[][] maze , int height , int width) {
		Node root = new Node();
	    ...
	    calculateBFSearch (n, goalNode, root ,maze,  height ,  width  , closedList, stack);
		}
	
	public void calculateBFSearch (Node n, Node goalNode,Node root, int[][] maze, int heightOfImage , int widthOfImage  , HashMap <String, Integer> closedList, Stack<Node> stack ) {
		int maxFrontier = 0;
		int expandedNodes =0;
	...
	public void displaySolutionPath (HashMap <String, Integer> closedList, int expandedNodes , int maxFrontier, Node n, Node root, Node goalNode) {
        ...
        System.out.println();
        setDFSSolutionPath(solutionPath);
	}
    ...
    public ArrayList<Node> getDFSSolutionPath() {
		return DFSSolutionPath;
	}



	public void setDFSSolutionPath(ArrayList<Node> dfsSolutionPath) {
		DFSSolutionPath = dfsSolutionPath;
	}
